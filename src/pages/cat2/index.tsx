    ...
    <View style={styles.container}>
      <View style={styles.containerImage}>
        ...
        <Text style={styles.corgisText}>
          British Shorthair cats are known for their calm and easygoing
          demeanor. They're typically independent yet affectionate, enjoying
          lounging around the house and being near their owners without being
          overly demanding. They are also known for their round faces and dense,
          plush coats, which give them a distinctive appearance.
        </Text>
        <Gap height={24} />
        <View>
          <TouchableOpacity
